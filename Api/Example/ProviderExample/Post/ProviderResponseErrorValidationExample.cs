...
{
    public class ProviderResponseErrorValidationExample : IMultipleExamplesProvider<Response<string>>
    {
        public IEnumerable<SwaggerExample<Response<string>>> GetExamples()
        {
            ...
            yield return SwaggerExample.Create("Example of validation provider", response);
        }
    }
}
