...
{
    public record UpdateProviderCommand(string Id, bool? IsActive, UpdateCompanyCommand? CompanyInfo, UpdateContactCommand? ContactInfo) : IRequest<Response<string>>;
